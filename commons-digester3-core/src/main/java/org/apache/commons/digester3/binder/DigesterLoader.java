...
public final class DigesterLoader
{
     ...
     * and the default {@link Rules} implementation.
     *
     * <strong>WARNING</strong> Input {@link XMLReader} will be linked to built Digester instance so it is recommended
     ...
     * and custom user define {@link Rules} implementation.
     *
     * <strong>WARNING</strong> Input {@link XMLReader} and {@link Rules} will be linked to built Digester instance,
     * so it is recommended to <strong>NOT</strong> share same {@link XMLReader} and {@link Rules} instance to produce the Digester.
     *
     * @param reader The user-defined {@code XMLReader}
     * @param rules The custom user define {@link Rules} implementation
     * @return A new {@link Digester} instance
